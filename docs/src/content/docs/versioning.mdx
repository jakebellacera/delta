...
| --- | --- | --- |
| `CHECK` constraints | [Delta Lake 0.8.0](https://github.com/delta-io/delta/releases/tag/v0.8.0) | [CHECK constraint](/apache-spark-connector/constraints/#check-constraint) |
| Generated columns | [Delta Lake 1.0.0](https://github.com/delta-io/delta/releases/tag/v1.0.0) | [Use generated columns](/apache-spark-connector/table-batch-reads-and-writes/#use-generated-columns) |
| Column mapping | [Delta Lake 1.2.0](https://github.com/delta-io/delta/releases/tag/v1.2.0) | [Delta column mapping](/apache-spark-connector/delta-column-mapping/) |
| Change data feed | [Delta Lake 2.0.0](https://github.com/delta-io/delta/releases/tag/v2.0.0) | [Change data feed](/apache-spark-connector/change-data-feed/) |
| Deletion vectors | [Delta Lake 2.3.0](https://github.com/delta-io/delta/releases/tag/v2.3.0) | [What are deletion vectors?](/apache-spark-connector/what-are-deletion-vectors/) |
...
| Clustering | [Delta Lake 3.1.0](https://github.com/delta-io/delta/releases/tag/v3.1.0) | [Use liquid clustering for Delta tables](/apache-spark-connector/use-liquid-clustering-for-delta-tables/) |
...
| Type widening (Preview) | [Delta Lake 3.2.0](https://github.com/delta-io/delta/releases/tag/v3.2.0) | [Delta type widening](/apache-spark-connector/delta-type-widening/) |
| Identity columns | [Delta Lake 3.3.0](https://github.com/delta-io/delta/releases/tag/v3.3.0) | [Use identity columns](/apache-spark-connector/table-batch-reads-and-writes/#use-identity-columns) |
| In-Commit Timestamps | [Delta Lake 3.3.0](https://github.com/delta-io/delta/releases/tag/v3.3.0) | [Use identity columns](/apache-spark-connector/table-batch-reads-and-writes/#use-identity-columns) |
...
| `CHECK` constraints | 3 | 1 | [CHECK constraint](/apache-spark-connector/constraints/#check-constraint) |
| Change data feed | 4 | 1 | [Change data feed](/apache-spark-connector/change-data-feed/) |
| Generated columns | 4 | 1 | [Use generated columns](/apache-spark-connector/table-batch-reads-and-writes/#use-generated-columns) |
| Column mapping | 5 | 2 | [Delta column mapping](/apache-spark-connector/delta-column-mapping/) |
| Identity columns | 6 | 1 | [Use identity columns](/apache-spark-connector/table-batch-reads-and-writes/#use-identity-columns) |
...
| Deletion vectors | 7 | 3 | [What are deletion vectors?](/apache-spark-connector/what-are-deletion-vectors/) |
...
| Row Tracking | 7 | 3 | [Use row tracking for Delta tables](/apache-spark-connector/use-row-tracking-for-delta-tables/) |
| Type widening (Preview) | 7 | 3 | [Delta type widening](/apache-spark-connector/delta-type-widening/) |
...
<TabItem label="Python">
  ```python from delta.tables import DeltaTable delta =
