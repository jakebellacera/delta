...
description: Learn how to use liquid clustering to optimize query performance in Delta Lake tables
---
...
<TabItem label="Python">
  ```python # Create an empty table DeltaTable.create() .tableName("table1")
  .addColumn("col0", dataType = "INT") .addColumn("col1", dataType = "STRING")
  .clusterBy("col0") .execute() ```
</TabItem>
...
>
  ...
  does Delta Lake manage feature
