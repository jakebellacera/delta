...
- `deletionVectors`. See [What are deletion vectors?](/apache-spark-connector/what-are-deletion-vectors/).
- `typeWidening-preview`. See [Delta type widening](/apache-spark-connector/delta-type-widening/). Type widening is available in preview in Delta Lake 3.2.0 and above.
...
- `columnMapping`. See [Delta column mapping](/apache-spark-connector/delta-column-mapping/). Drop support for column mapping is available in Delta Lake 3.3.0 and above.
...
- `checkConstraints`. See [Constraints](/apache-spark-connector/constraints/). Drop support for check constraints is available in Delta Lake 3.3.0 and above.
- `inCommitTimestamp`. See [In-Commit Timestamps](/apache-spark-connector/table-batch-reads-and-writes/#in-commit-timestamps). In-Commit Timestamp is available in Delta Lake 3.3.0 and above.
...
See [How does Delta Lake manage feature compatibility?](/apache-spark-connector/how-does-delta-lake-manage-feature-compatibility/).
