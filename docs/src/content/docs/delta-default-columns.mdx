...
<Aside type="note">
  ...
  feature](/apache-spark-connector/how-does-delta-lake-manage-feature-compatibility/#what-are-table-features).
</Aside>
...
>
  ...
  to support [table
  features](/apache-spark-connector/how-does-delta-lake-manage-feature-compatibility/#what-are-table-features).
